import { COOKIE_NAME, ONE_YEAR_MS, SESSION_APP_ID } from "@shared/const";
...
class SDKServer {
   ...
   * @example
   * const sessionToken = await sdk.createSessionToken(`local-${localUser.id}`);
   */
